...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            {{-- Mensaje en caso de actualizar datos --}}
                    ...
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="image_path" type="file" class="@error('image_path') is-invalid @enderror" name="image_path" autocomplete="name" autofocus>
